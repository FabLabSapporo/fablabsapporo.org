...
::: danger Application 締め切り
FabAcademy2025の申し込み締め切りは2024年12月25日です。お早めにお申し込みください。[お申し込み](#application-process)の流れもご覧ください。
:::
...
> FabAcademyは、毎週新しいプロジェクトを計画・実行することで、ラピッドプロトタイピングを学び、技術スキルの個人ポートフォリオを作成する、テンポの速い実践的な学習体験です。
